...
public class HotmailTest {
	  ...
	  public void testHotmail() throws Exception {
	     ...
	     driver.findElement(By.id("i0118")).sendKeys("earth1");
	     driver.findElement(By.id("idSIButton9")).click();
	     
	     // Explicit wait example:
	     WebDriverWait wait = new WebDriverWait(driver, 30/*timeout in seconds*/);
	     wait.until(ExpectedConditions.textToBePresentInElement(By.className("emptySel"), "Kattintson az itt megjeleníteni kívánt üzenetre."));
